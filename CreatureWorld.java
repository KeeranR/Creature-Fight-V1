 ...
 * 
 * Name: Keeran Rattan
 * Course: Creature Fight (Part One)
...
public class CreatureWorld extends World
{
    ...
    private Creature playerOne;
    private Creature playerTwo;
    ...
    {    
         ...
         */
        playerOne = new Charmander(this);
        playerTwo = new Pikachu(this);
    ...
    public void act()
    {
        ...
        if(playerOne.getHealthBar().getCurrent()<=0)
        {
        ...
        if(playerTwo.getHealthBar().getCurrent()<=0)
        {
    ...
    {
        addObject( playerOne, playerOne.getImage().getWidth()/2, getHeight() - playerOne.getImage().getHeight()/2);

        addObject( new Button(Color.RED, 50), getWidth()/2, getHeight() - 100);

        addObject( playerTwo, getWidth() - playerTwo.getImage().getWidth()/2, playerTwo.getImage().getHeight()/2);
